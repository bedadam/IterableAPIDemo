...
/// <code>CommerceItem</code> represents a product. These are used by the commerce API; see [IterableAPI trackPurchase:items:dataFields:]
...
- (nonnull instancetype)initWithId:(NSString * _Nonnull)id name:(NSString * _Nonnull)name price:(NSNumber * _Nonnull)price quantity:(NSUInteger)quantity OBJC_DESIGNATED_INITIALIZER;
/// A Dictionary respresentation of this item
///
/// returns:
/// An NSDictionary representing this item
...
///
+ (void)initializeWithApiKey:(NSString * _Nonnull)apiKey config:(IterableConfig * _Nonnull)config;
...
/// \param config The <code>IterableConfig</code> object with the settings to be used
///
+ (void)initializeWithApiKey:(NSString * _Nonnull)apiKey launchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions config:(IterableConfig * _Nonnull)config;
/// DO NOT USE THIS.
/// This method is used internally to connect to staging and test environments.
+ (void)initialize2WithApiKey:(NSString * _Nonnull)apiKey launchOptions:(NSDictionary<UIApplicationLaunchOptionsKey, id> * _Nullable)launchOptions config:(IterableConfig * _Nonnull)config apiEndPointOverride:(NSString * _Nullable)apiEndPointOverride linksEndPointOverride:(NSString * _Nullable)linksEndPointOverride callback:(void (^ _Nullable)(BOOL))callback;
...
///
/// \param token The new authentication token for this user
///
/// \param onSuccess <code>OnSuccessHandler</code> to invoke if update is successful
///
/// \param onFailure <code>OnFailureHandler</code> to invoke if update fails
...
@interface IterableAPI (SWIFT_EXTENSION(IterableSDK))
+ (void)showSystemNotificationWithTitle:(NSString * _Nonnull)title body:(NSString * _Nonnull)body button:(NSString * _Nullable)button callbackBlock:(void (^ _Nullable)(NSString * _Nullable))callbackBlock SWIFT_DEPRECATED_MSG("Please use UIAlertController to show system notifications.");
+ (void)showSystemNotificationWithTitle:(NSString * _Nonnull)title body:(NSString * _Nonnull)body buttonLeft:(NSString * _Nullable)buttonLeft buttonRight:(NSString * _Nullable)buttonRight callbackBlock:(void (^ _Nullable)(NSString * _Nullable))callbackBlock SWIFT_DEPRECATED_MSG("Please use UIAlertController to show system notifications.");
+ (void)getAndTrackDeeplink:(NSURL * _Nonnull)webpageURL callbackBlock:(void (^ _Nonnull)(NSString * _Nullable))callbackBlock SWIFT_DEPRECATED_MSG("Please use IterableAPI.handle(universalLink:) instead.");
+ (void)trackInAppOpen:(NSString * _Nonnull)messageId SWIFT_DEPRECATED_MSG("Use IterableAPI.track(inAppOpen:location:) method instead.");
+ (void)trackInAppClick:(NSString * _Nonnull)messageId buttonURL:(NSString * _Nonnull)buttonURL SWIFT_DEPRECATED_MSG("Use IterableAPI.track(inAppClick:location:clickedUrl) instead.");
+ (void)inAppConsume:(NSString * _Nonnull)messageId SWIFT_DEPRECATED_MSG("Use IterableAPI.inAppConsume(message:location:source:) instead.");
@end
...
/// Action type
/// If type is <code>openUrl</code>, the SDK will call <code>IterableURLDelegate</code> and then try to open the URL if
...
///
/// returns:
/// <code>IterableAction</code> instance
...
typedef SWIFT_ENUM(NSInteger, IterableActionSource, open) {
...
/// automatically if you pass one. If you handle completionHandler in the app code, pass a nil value to this argument.
///
+ (void)userNotificationCenter:(UNUserNotificationCenter * _Nullable)center didReceiveNotificationResponse:(UNNotificationResponse * _Nonnull)response withCompletionHandler:(void (^ _Nullable)(void))completionHandler SWIFT_AVAILABILITY(ios,introduced=10.0);
- (nonnull instancetype)init SWIFT_UNAVAILABLE;
+ (nonnull instancetype)new SWIFT_UNAVAILABLE_MSG("-init is unavailable");
@end
...
@property (nonatomic) BOOL checkForDeferredDeeplink;
/// Implement the protocol IterableLogDelegate and set it here to change logging.
/// Out of the box you have the following
/// <ol>
///   <li>
///     DefaultLogDelegate. It will use OsLog for .error, cosole for .info and no logging for debug.
///   </li>
///   <li>
///     NoneLogDelegate. No logging messages will be output.
///   </li>
///   <li>
///     AllLogDelegate. It will log everything to console.
...
typedef SWIFT_ENUM(NSInteger, IterableInAppContentType, open) {
...
typedef SWIFT_ENUM(NSInteger, IterableInAppTriggerType, open) {
...
/// \param forCell The table view cell to render
///
/// \param withMessage IterableInAppMessage
///
- (void)renderAdditionalFieldsForCell:(IterableInboxCell * _Nonnull)cell withMessage:(IterableInAppMessage * _Nonnull)message;
@end


SWIFT_PROTOCOL("_TtP11IterableSDK35IterableInternalAuthManagerProtocol_")
@protocol IterableInternalAuthManagerProtocol
...
///
/// returns:
/// Boolean value. Return true if the URL was handled to override default behavior.
- (BOOL)handleIterableURL:(NSURL * _Nonnull)url context:(IterableActionContext * _Nonnull)context SWIFT_WARN_UNUSED_RESULT;
@end

typedef SWIFT_ENUM_NAMED(NSInteger, IterableLogLevel, "LogLevel", open) {
...
typedef SWIFT_ENUM(NSInteger, PushServicePlatform, open) {
